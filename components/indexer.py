...
class Indexer():
    ...
    def __init__(self):
        ...
        kicker_motor_configs.commutation.motor_arrangement = signals.MotorArrangementValue.NEO550_JST
        ...
        conveyor_motor_configs.motor_output.neutral_mode = signals.NeutralModeValue.COAST
        conveyor_motor_configs.commutation.motor_arrangement = signals.MotorArrangementValue.BRUSHED_DC
